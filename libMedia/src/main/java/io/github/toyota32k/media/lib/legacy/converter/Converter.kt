...
import io.github.toyota32k.media.lib.legacy.converter.TrimmingRangeKeeper.Companion.toKeeper
...
import io.github.toyota32k.media.lib.utils.RingBuffer
...
import io.github.toyota32k.media.lib.legacy.track.AudioTrack
...
//            = trimmingEndTo(time.inWholeMilliseconds)
        ...
        fun rotate(rotation: Rotation?) = apply {
            mRotation = if (rotation == Rotation.Companion.nop) null else rotation
        }
